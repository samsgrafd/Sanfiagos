    ...
    $( window ).on('load', function() {
        ...
        function shopstar_toggle_slider_options( sliderType ) {
            if ( sliderType == 'shopstar-slider-default' ) {
            	$( '#customize-control-shopstar-default-slider-info' ).show();
            	$( '#customize-control-shopstar-slider-plugin-info' ).hide();
                ...
                $( '#customize-control-shopstar-slider-enabled-warning' ).show();
                
            } else if ( sliderType == 'shopstar-slider-plugin' ) {
            	$( '#customize-control-shopstar-default-slider-info' ).hide();
            	$( '#customize-control-shopstar-slider-plugin-info' ).show();
                ...
                // Header image visibility warning
                $( '#customize-control-shopstar-slider-enabled-warning' ).hide();
