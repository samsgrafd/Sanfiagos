...
<div class="featured-image-container loading">
	...
	$thumbnail_image = wp_get_attachment_image_src( $thumbnail_id, get_theme_mod( 'shopstar-blog-featured-image-size', customizer_library_get_default( 'shopstar-blog-featured-image-size' ) ) );
	?>
