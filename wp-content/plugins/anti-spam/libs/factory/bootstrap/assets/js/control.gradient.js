( function( $ ){
    ...
    $.fn.factoryBootstrap436_gradientControl = function (option) {
    ...
    $.fn.factoryBootstrap436_gradientControl.Constructor = GradientControl;
    
    // GRADIENT CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-436 .factory-gradient").factoryBootstrap436_gradientControl();
    });
