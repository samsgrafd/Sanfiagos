( function( $ ){
    ...
    $.fn.factoryBootstrap436_paddingsEditor = function (option) {
    ...
    $.fn.factoryBootstrap436_paddingsEditor.Constructor = PaddingsEditor;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-436 .factory-paddings-editor").factoryBootstrap436_paddingsEditor();
    });
